...
function Edit() {
  ...
  const deleteProject = () => {
    axios
      .delete(`${process.env.REACT_APP_SERVER_URL}/spaces/${spacesId}`)
    ...
    <div className="bg-red-100">
      ...
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <form onSubmit={handleSubmit} className="max-w-md w-full space-y-8">
          ...
          <br />
          <button
            className="text-white bg-red-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
